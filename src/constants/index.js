...
const services = [
  ...
  },
  {
    title: "About Nishant",
    icon: nishant_ghibli,
    description: "Nishant specializes in nishant_ghibli and responsive development, making apps accessible to everyone.",
    description: "Nishant specializes in nishant_ghibli and responsive development, making apps accessible to everyone.",
  },
  {
    title: "About Surbhi",
    icon: surbhi_ghibli,
    description: "Surbhi handles surbhi_ghibli and APIs, building scalable and efficient solutions for agriculture tech.",
  },
  {
    title: "About Pritul",
    icon: shivanighibli,
...
const experiences = [
  ...
  },
  {
    ...
    date: "Phase 2",
    points: [
      "Set up the surbhi_ghibli with Django for handling data and API endpoints.",
      "Integrated user authentication and storage systems.",
      "Ensured smooth communication between frontend and surbhi_ghibli.",
    ],
  },
  {
